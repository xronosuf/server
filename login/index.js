    ...
    [
      ...
      function (bridge, callback) {
        ...
        bridge
          ...
          .then(function () {
            /*
             * Only a bridge persisted from the already-validated LTI request
             * may materialize shell settings. Ordinary guest/non-LTI traffic
             * never enters this path.
             */
            return instructorSettings.ensureGlobalForBridge(bridge)
              .catch(function (settingsErr) {
                console.log(
                  "Could not ensure instructor settings for LTI bridge " +
                    bridge._id
                );
