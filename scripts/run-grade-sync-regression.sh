...
TEST_FILES=(
  ...
  test/grade-sync-recovery-report.js
...
cp /workspace/scripts/grade-sync-recovery-report.js "$TEST_ROOT/scripts/"
...
cp /workspace/test/grade-sync-recovery-report.js "$TEST_ROOT/test/"
