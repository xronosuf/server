...
| Sage display | `main.js`, `sagemath.js`, MathJax | Sage request result | mapping, placeholder, MathJax | visible render or fallback | incomplete | `RETAIN`; enforce terminal component state |
