...
var ximeraUrl = window.location.protocol + "//" + window.location.host + "/";
...
exports.experienceProblem = function (element) {
  return exports.experienceProblemById(
    $(element).activityHash(),
    $(element).attr("id")
  );
};
...
var freeResponseUrl = function (element) {
  ...
  var url =
    ximeraUrl + "activities/" + activityHash + "/freeResponse/" + answerId;
...
exports.experience = function (element) {
  if ($(element).hasClass("activity")) exports.experienceActivity(element);
  else if ($(element).hasClass("problem-environment"))
    exports.experienceProblem(element);
  else throw "I do not know how to 'experience' this DOM element.";
};
...
exports.recordVerbObject = function (verb, object, others) {
  ...
  if (others) _.extend(statement, others);
