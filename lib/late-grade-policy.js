...
function passbackWindowEnd(bridge, fallbackDays) {
    ...
    /*
     * Instructor settings are materialized onto each validated LTI bridge so
     * background grade workers can resolve the shell policy synchronously.
     * The shell-level instructor settings document remains authoritative.
     */
    ...
    /*
     * Backwards compatibility for bridges created before the instructor
     * settings rollout and not yet refreshed by a validated LTI launch.
     */
